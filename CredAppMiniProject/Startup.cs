...
namespace CredAppMiniProject
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //ConnectionString
            services.AddDbContext<CredPayAppDbContext>(options =>
     options.UseSqlServer(Configuration.GetConnectionString("Default")));
            //service
            services.AddTransient<ICardDetailService, CardDetailService>();
            services.AddTransient<CardDetailsDal, CardDetailsDal>();
            ...
            services.AddSwaggerGen(swagger =>
            {
                ...
                swagger.AddSecurityDefinition("Bearer", new OpenApiSecurityScheme()
                {
                    ...
                    Description = "Bearer 44352/api/Authenticate/",
                });
